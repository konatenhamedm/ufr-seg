...
class InscriptionRejeterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('annuler', SubmitType::class, ['label' => 'Annuler', 'attr' => ['class' => 'btn btn-primary btn-sm', 'data-bs-dismiss' => 'modal']])
            ...
            ->add('resoumettre', SubmitType::class, ['label' => 'Soumettre à nouveau', 'attr' => ['class' => 'btn btn-warning btn-ajax btn-sm']]);
    }
