...
class CoursController extends AbstractController
{
    ...
    public function getClasse(Request $request, CoursRepository $coursRepository, SessionInterface $session)
    {
        $response = new Response();
        $tabMatieres = array();
        ...
        //dd($matieres);
        $matieres = $coursRepository->getClasse($session->get("anneeScolaire"));
        $i = 0;
    ...
    public function getUe(Request $request, ClasseRepository $classeRepository, UniteEnseignementRepository $uniteEnseignementRepository)
    {
        ...
        if ($idClasse) {
            ...
            $uniteEnseigenments = $uniteEnseignementRepository->findby(['niveau' => $classeRepository->find($idClasse)->getNiveau()]);
