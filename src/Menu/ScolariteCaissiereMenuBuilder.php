...
class ScolariteCaissiereMenuBuilder
{
    ...
    public function createMainMenu(array $options): ItemInterface
    {
        ...
        if (isset($menu[self::MODULE_NAME])) {
            ...
            $menu->addChild('inscription.caissiere', ['route' => 'app_liste_inscription_etudiant_admin_index', 'label' => ' Inscription'])->setExtra('icon', 'bi bi-gear')->setExtra('role', 'ROLE_CAISSIERE');
