...
class EvaluationMenuBuilder
{
    ...
    public function createMainMenu(array $options): ItemInterface
    {
        ...
        if (isset($menu[self::MODULE_NAME])) {
            ...
            //$menu->addChild('typeEvaluation.index', ['route' => 'app_controle_type_evaluation_index', 'label' => 'Type de Controles'])->setExtra('icon', 'bi bi-gear')->setExtra('role', 'ROLE_SECRETAIRE');
