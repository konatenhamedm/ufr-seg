...
insert  into `evaluation_controle`(`id`,`cour_id`,`ue_id`,`semestre_id`,`utilisateur_id`,`matiere_id`,`classe_id`,`annee_scolaire_id`,`date_saisie`,`date_compo`,`type_controle_id`) values 
(1,9,4,1,1,2,10,1,'2024-06-06 17:20:56','2024-06-06 17:20:56',1),
(2,8,4,1,1,1,10,1,'2024-06-06 17:59:35','2024-06-06 17:59:35',1);
...
insert  into `evaluation_examen_controle`(`id`,`ue_id`,`session_id`,`type_controle_id`) values 
(4,4,4,1,2);
...
insert  into `evaluation_examen_decision`(`id`,`etudiant_id`,`note_examen`,`moyenne_controle`,`nombre_credit`,`moyenne_annuelle`,`decision`,`session_id`) values 
...
insert  into `gestion_frais`(`id`,`type_frais_id`,`montant`) values 
(28,1,4,100000),
(29,2,4,50000),
(30,3,4,2000),
(31,1,5,2500),
...
insert  into `inscription`(`id`,`date_inscription`,`montant`,`code_utilisateur`,`date_paiement`,`etudiant_id`,`etat`,`caissiere_id`,`code`,`commentaire`,`total_paye`,`classe_id`) values 
...
CREATE TABLE `param_fonction` (
  ...
  `code` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_544A947977153098` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `param_fonction` */

insert  into `param_fonction`(`id`,`libelle`,`code`) values 
...
/*Table structure for table `param_genre` */
...
/*Data for the table `param_genre` */

insert  into `param_genre`(`id`,`code`,`libelle`) values 
(1,'H','Homme');
...
CREATE TABLE `param_session` (
  ...
  `date_fin` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `numero_session` (`numero`,),
 
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `param_session` */

insert  into `param_session`(`id`,`libelle`,`date_debut`,`numero`,`date_fin`) values 
...
(46,'Christmas (l\'Île)'),
(47,'Chypre'),
(48,'Cocos (les Îles) / Keeling (les Îles)'),
(49,'Colombie '),
(50,'Comores '),
(51,'Congo '),
(52,'Congo (la République démocratique du)'),
(53,'Cook (les Îles)'),
(54,'Corée (la République de)'),
(55,'Corée (la République populaire démocratique de)'),
(56,'Costa Rica '),
(57,'Côte d\'Ivoire '),
(58,'Croatie '),
(59,'Cuba'),
...
(71,'Estonie '),
(72,'Eswatini '),
(73,'États-Unis d\'Amérique '),
(74,'Éthiopie '),
(75,'Falkland (les Îles) /Malouines (les Îles)'),
(76,'Féroé (les Îles)'),
(77,'Fidji '),
(78,'Finlande '),
(79,'France '),
...
(92,'Guernesey'),
(93,'Guinée '),
(94,'Guinée équatoriale '),
(95,'Guinée-Bissau '),
(96,'Guyana '),
(97,'Guyane française (la)'),
(98,'Haïti'),
(99,'Heard-et-Îles MacDonald (l\'Île)'),
(100,'Honduras '),
(101,'Hong Kong'),
(102,'Hongrie '),
(103,'Île de Man'),
...
(105,'Inde '),
(106,'Indien (le Territoire britannique de l\'océan)'),
(107,'Indonésie '),
(108,'Iran (République Islamique d\')'),
(109,'Iraq '),
(110,'Irlande '),
(111,'Islande '),
(112,'Israël'),
...
(121,'Kiribati'),
(122,'Koweït '),
(123,'Lao (la République démocratique populaire)'),
(124,'Lesotho '),
(125,'Lettonie '),
(126,'Liban '),
(127,'Libéria '),
...
(138,'Mali '),
(139,'Malte'),
(140,'Mariannes du Nord (les Îles)'),
(141,'Maroc '),
(142,'Marshall (les Îles)'),
(143,'Martinique '),
(144,'Maurice'),
(145,'Mauritanie '),
(146,'Mayotte'),
(147,'Mexique '),
(148,'Micronésie (États fédérés de)'),
(149,'Moldavie (la République de)'),
(150,'Monaco'),
(151,'Mongolie '),
(152,'Monténégro '),
(153,'Montserrat'),
...
(179,'Pitcairn'),
(180,'Pologne '),
(181,'Polynésie française '),
(182,'Porto Rico'),
(183,'Portugal '),
(184,'Qatar '),
(185,'République arabe syrienne '),
(186,'République centrAfriqueine '),
(187,'Réunion '),
(188,'Roumanie '),
(189,'Royaume-Uni de Grande-Bretagne et d\'Irlande du Nord '),
(190,'Russie (la Fédération de)'),
(191,'Rwanda '),
...
(219,'Suisse '),
(220,'Suriname '),
(221,'Svalbard et l\'Île Jan Mayen '),
(222,'Tadjikistan '),
(223,'Taïwan (Province de Chine)'),
(224,'Tanzanie (la République-Unie de)'),
(225,'Tchad '),
(226,'Tchéquie '),
(227,'Terres australes françaises '),
(228,'Thaïlande '),
(229,'Timor-Leste '),
(230,'Togo '),
(231,'Tokelau '),
(232,'Tonga '),
(233,'Trinité-et-Tobago '),
(234,'Tunisie '),
(235,'Turkménistan '),
(236,'Turks-et-Caïcos (les Îles)'),
(237,'Turquie '),
(238,'Tuvalu '),
(239,'Ukraine '),
(240,'Uruguay '),
...
(243,'Vierges britanniques (les Îles)'),
(244,'Vierges des États-Unis (les Îles)'),
(245,'Viet Nam '),
...
(276,'Bermudes '),
(277,'Bhoutan '),
(278,'Bolivie (État plurinational de)'),
(279,'Bonaire, Saint-Eustache et Saba'),
(280,'Bosnie-Herzégovine '),
(281,'Botswana '),
(282,'Bouvet (l\'Île)'),
(283,'Brésil '),
(284,'Brunéi Darussalam '),
(285,'Bulgarie '),
(286,'Burkina Faso '),
(287,'Burundi '),
(288,'Cabo Verde'),
(289,'Caïmans (les Îles)'),
(290,'Cambodge '),
(291,'Cameroun '),
(292,'Canada '),
(293,'Chili '),
...
(295,'Christmas (l\'Île)'),
(296,'Chypre'),
(297,'Cocos (les Îles) / Keeling (les Îles)'),
(298,'Colombie '),
(299,'Comores '),
(300,'Congo '),
(301,'Congo (la République démocratique du)'),
(302,'Cook (les Îles)'),
(303,'Corée (la République de)'),
(304,'Corée (la République populaire démocratique de)'),
(305,'Costa Rica '),
(306,'Côte d\'Ivoire '),
(307,'Croatie '),
(308,'Cuba'),
...
(310,'Danemark '),
(311,'Djibouti'),
(312,'dominicaine (la République)'),
(313,'Dominique '),
(314,'Égypte '),
(315,'El Salvador'),
(316,'Émirats arabes unis '),
(317,'Équateur '),
(318,'Érythrée '),
(319,'Espagne '),
(320,'Estonie '),
(321,'Eswatini '),
(322,'États-Unis d\'Amérique '),
(323,'Éthiopie '),
(324,'Falkland (les Îles) /Malouines (les Îles)'),
(325,'Féroé (les Îles)'),
(326,'Fidji '),
(327,'Finlande '),
(328,'France '),
...
(330,'Gambie '),
(331,'Géorgie '),
(332,'Géorgie du Sud-et-les Îles Sandwich du Sud '),
(333,'Ghana '),
(334,'Gibraltar'),
(335,'Grèce '),
(336,'Grenade '),
...
(341,'Guernesey'),
(342,'Guinée '),
(343,'Guinée équatoriale '),
(344,'Guinée-Bissau '),
(345,'Guyana '),
(346,'Guyane française (la)'),
(347,'Haïti'),
(348,'Heard-et-Îles MacDonald (l\'Île)'),
(349,'Honduras '),
(350,'Hong Kong'),
(351,'Hongrie '),
(352,'Île de Man'),
(353,'Îles mineures éloignées des États-Unis '),
(354,'Inde '),
(355,'Indien (le Territoire britannique de l\'océan)'),
(356,'Indonésie '),
(357,'Iran (République Islamique d\')'),
(358,'Iraq '),
(359,'Irlande '),
(360,'Islande '),
(361,'Israël'),
...
(370,'Kiribati'),
(371,'Koweït '),
(372,'Lao (la République démocratique populaire)'),
(373,'Lesotho '),
(374,'Lettonie '),
(375,'Liban '),
(376,'Libéria '),
...
(387,'Mali '),
(388,'Malte'),
(389,'Mariannes du Nord (les Îles)'),
(390,'Maroc '),
(391,'Marshall (les Îles)'),
(392,'Martinique '),
(393,'Maurice'),
(394,'Mauritanie '),
(395,'Mayotte'),
(396,'Mexique '),
(397,'Micronésie (États fédérés de)'),
(398,'Moldavie (la République de)'),
(399,'Monaco'),
(400,'Mongolie '),
(401,'Monténégro '),
(402,'Montserrat'),
...
(412,'Norfolk (l\'Île)'),
(413,'Norvège '),
(414,'Nouvelle-Calédonie '),
(415,'Nouvelle-Zélande '),
(416,'Oman'),
(417,'Ouganda '),
(418,'Ouzbékistan '),
(419,'Pakistan '),
(420,'Palaos '),
(421,'Palestine, État de'),
(422,'Panama '),
(423,'Papouasie-Nouvelle-Guinée '),
(424,'Paraguay '),
(425,'Pays-Bas '),
(426,'Pérou '),
(427,'Philippines '),
(428,'Pitcairn'),
(429,'Pologne '),
(430,'Polynésie française '),
(431,'Porto Rico'),
(432,'Portugal '),
(433,'Qatar '),
(434,'République arabe syrienne '),
(435,'République centrAfriqueine '),
(436,'Réunion '),
(437,'Roumanie '),
(438,'Royaume-Uni de Grande-Bretagne et d\'Irlande du Nord '),
(439,'Russie (la Fédération de)'),
(440,'Rwanda '),
(441,'Sahara occidental'),
(442,'Saint-Barthélemy'),
(443,'Sainte-Hélène, Ascension et Tristan da Cunha'),
(444,'Sainte-Lucie'),
(445,'Saint-Kitts-et-Nevis'),
(446,'Saint-Marin'),
(447,'Saint-Martin (partie française)'),
(448,'Saint-Martin (partie néerlandaise)'),
(449,'Saint-Pierre-et-Miquelon'),
(450,'Saint-Siège '),
(451,'Saint-Vincent-et-les Grenadines'),
(452,'Salomon (les Îles)'),
(453,'Samoa '),
(454,'Samoa américaines '),
(455,'Sao Tomé-et-Principe'),
(456,'Sénégal '),
(457,'Serbie '),
(458,'Seychelles '),
(459,'Sierra Leone '),
...
(468,'Suisse '),
(469,'Suriname '),
(470,'Svalbard et l\'Île Jan Mayen '),
(471,'Tadjikistan '),
(472,'Taïwan (Province de Chine)'),
(473,'Tanzanie (la République-Unie de)'),
(474,'Tchad '),
(475,'Tchéquie '),
(476,'Terres australes françaises '),
(477,'Thaïlande '),
(478,'Timor-Leste '),
(479,'Togo '),
(480,'Tokelau '),
(481,'Tonga '),
(482,'Trinité-et-Tobago '),
(483,'Tunisie '),
(484,'Turkménistan '),
(485,'Turks-et-Caïcos (les Îles)'),
(486,'Turquie '),
(487,'Tuvalu '),
(488,'Ukraine '),
(489,'Uruguay '),
(490,'Vanuatu '),
(491,'Venezuela (République bolivarienne du)'),
(492,'Vierges britanniques (les Îles)'),
(493,'Vierges des États-Unis (les Îles)'),
(494,'Viet Nam '),
(495,'Wallis-et-Futuna'),
(496,'Yémen '),
(497,'Zambie '),
(498,'Zimbabwe');
...
CREATE TABLE `stage` (
  ...
  CONSTRAINT `FK_C27C9369DDEAB1A3` FOREIGN KEY (`etudiant_id`) REFERENCES `user_etudiant` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `stage` */

insert  into `stage`(`id`,`etudiant_id`,`libelle`,`employeur`,`contact`,`date_debut`,`date_fin`,`activite`) values 
(1,31,'cc','ddd','ddd','2024-02-08 00:00:00','2024-02-14 00:00:00','ddd');
...
CREATE TABLE `test` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_D87F7E0CF915CFE` (`fichier_id`),
  CONSTRAINT `FK_D87F7E0CF915CFE` FOREIGN KEY (`fichier_id`) REFERENCES `param_fichier` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `test` */

insert  into `test`(`id`,`fichier_id`) values 
(1,39);
...
insert  into `unite_enseignement`(`id`,`semestre_id`,`code_ue`,`libelle`,`coef`,`attribut`,`volume_horaire`,`total_credit`) values 
...
CREATE TABLE `user_document` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_38E46E76DDEAB1A3` (`etudiant_id`),
  KEY `IDX_38E46E76F915CFE` (`fichier_id`),
  CONSTRAINT `FK_38E46E76DDEAB1A3` FOREIGN KEY (`etudiant_id`) REFERENCES `user_etudiant` (`id`),
  CONSTRAINT `FK_38E46E76F915CFE` FOREIGN KEY (`fichier_id`) REFERENCES `param_fichier` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `user_document` */

insert  into `user_document`(`id`,`fichier_id`,`description`,`libelle`,`etudiant_id`,`updated_at`) values 
(52,20,'document','doc_motivation',31,'2024-02-26 11:24:08'),
(57,21,'document','doc_cv',31,'2024-02-26 12:14:19'),
(58,48,'document','doc_piece_identite',31,'2024-03-26 08:21:18'),
(59,51,'document','doc_motivation',31,'2024-03-31 21:31:52');

/*Table structure for table `user_employe` */

DROP TABLE IF EXISTS `user_employe`;

CREATE TABLE `user_employe` (
  `id` int NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_A009CDB3BF396750` FOREIGN KEY (`id`) REFERENCES `user_personne` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `user_employe` */

insert  into `user_employe`(`id`) values 
(2),
(29),
(37),
(38),
...
/*Data for the table `user_groupe` */

insert  into `user_groupe`(`id`,`libelle`,`description`,`roles`) values 
(1,'Super Administrateur','Super Administrateur','[\"ROLE_SUPER_ADMIN\", \"ROLE_ADMIN\"]'),
(2,'Etudiants','Compte etudiant','[\"ROLE_ETUDIANT\"]'),
(3,'Caissière ','Super Administrateur','[\"ROLE_CAISSIERE\"]'),
(4,'Comptable','Comptable','[\"ROLE_COMPTABLE\"]'),
(5,'Secrétaire','Secrétaire','[\"ROLE_SECRETAIRE\"]'),
(6,'Directeur ','Directeur de filière','[\"ROLE_DIRECTEUR\"]');
...
CREATE TABLE `user_personne` (
  ...
  `discr` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_EF432DEFE7927C74` (`email`),
  KEY `IDX_EF432DEF4296D31F` (`genre_id`),
  KEY `IDX_EF432DEF39194ABF` (`civilite_id`),
  KEY `IDX_EF432DEF57889920` (`fonction_id`),
  CONSTRAINT `FK_EF432DEF39194ABF` FOREIGN KEY (`civilite_id`) REFERENCES `param_civilite` (`id`),
  CONSTRAINT `FK_EF432DEF4296D31F` FOREIGN KEY (`genre_id`) REFERENCES `param_genre` (`id`),
  CONSTRAINT `FK_EF432DEF57889920` FOREIGN KEY (`fonction_id`) REFERENCES `param_fonction` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `user_personne` */

insert  into `user_personne`(`id`,`genre_id`,`civilite_id`,`fonction_id`,`nom`,`prenom`,`date_naissance`,`lieu_naissance`,`email`,`contact`,`discr`) values 
(1,1,1,1,'UFR','SEG','2023-11-14','Abidjan4','kon@gmail.com','','personne'),
(2,1,1,4,'Konate','Hamed','2023-11-10','Daloa','konatenhamed@gmail.com','0778887541','employe'),
(3,1,1,2,'Konate','Hamed','2023-11-10','dd','konzzatenhamed@gmail.com','0778887541','etudiant'),
(4,1,1,2,'Konate','Hamed','2023-11-10','d','konddatenhamcced@gmail.com','0778887541','etudiant'),
(5,1,1,2,'llll','yyy','2023-11-08','d','kondssdatenhamejjnd@gmail.com','0778887541','etudiant'),
(6,1,1,2,'ddd','ddd','2023-11-16','d','ddd@gmail.com','0778887541','etudiant'),
(7,NULL,NULL,2,'ddd','ddd','2023-11-16','dd','dddddd@gmail.com','0778887541','etudiant'),
(8,NULL,NULL,2,'ddd','ddd','2023-11-16','dd','dddsddddd@gmail.com',NULL,'etudiant'),
(9,NULL,NULL,2,'yyy','yy','2023-11-16','dd','888@gmail.com',NULL,'etudiant'),
(10,NULL,NULL,2,'yyy','yy','2023-11-16','dd','8c88@gmail.com',NULL,'etudiant'),
(11,NULL,NULL,2,'yyy','yy','2023-11-16','dd','88c8@gmail.com',NULL,'etudiant'),
(12,NULL,NULL,2,'ddd','cdd','2023-11-24','ddd','tyy@gmail.com',NULL,'etudiant'),
(13,NULL,NULL,2,'Konate','Hamed','2023-11-15','dd','konatenhdddamed@gmail.com',NULL,'etudiant'),
(14,1,1,2,'soro','soro','2023-11-23','dd','soro@gmail.com',NULL,'etudiant'),
(15,1,1,2,'sss','dd','2023-11-16','dd','kona55tenhamed@gmail.com',NULL,'etudiant'),
(16,1,1,2,'Konate','Hamed','2023-11-30','dd','abou@gmail.com',NULL,'etudiant'),
(19,1,1,2,'cd','dd','2023-11-09','dd','koccccn@gmail.com',NULL,'etudiant'),
(20,1,1,2,'Konate','Hamed','2023-11-09','dd','koncccc@gmail.com',NULL,'etudiant'),
(21,1,1,2,'Konate','Hamed','2023-11-15','dd','ko9665n@gmail.com',NULL,'etudiant'),
(26,1,1,2,'rrr','rrrr','2023-11-16','Gbon','ddd000','0778887541','etudiant'),
(27,1,1,2,'dd','dd','2023-11-15','dd','83424','7888754156','etudiant'),
(28,1,1,2,'dddd','ddd','2023-11-16','dd','bbcc@gmail.com','7888754156','etudiant'),
(29,1,1,3,'UUU',' Ddd Messi','2024-01-16','DALOA','leo@gmail.com','78887541','employe'),
(30,1,1,2,'KONATE','Ngolo Hamed','2024-02-16','d','mam@gmail.com','0778887541','etudiant'),
(31,1,1,2,'KONATE','Hamed','2024-02-09','hhhKON','fff88433','0778887541','etudiant'),
(32,1,1,2,'EMMMA','Emma','2024-02-14','dd','emma','888885555','etudiant'),
(33,1,1,2,'EMMA','Emma','2024-02-07','dd','emma@gmail.com','0778887541','etudiant'),
(34,1,1,2,'KONATE','Hamed','2024-02-08','dd','reaal@gmail.com','0778887541','etudiant'),
(35,1,1,2,'KONATE','Hamed','2024-02-06','dd','reaa555ls@gmail.com','0778887541','etudiant'),
(36,1,1,2,'KONATE','Hamed','2024-02-08','dd','yes@gmail.com','0778887541','etudiant'),
(37,1,1,3,'comptable','comptable','2024-03-06','eeee','comptable@gmail.com','88888888','employe'),
(38,1,1,6,'Secretaire','secretaire','2024-03-13','lpjpo','secretaire@gmail.com','888885','employe'),
(39,1,1,6,'deuxieme','comptable','2024-03-14','ddd','ddd','fddd','employe'),
(40,1,1,4,'Directeur','Directeur','2024-03-15','888','directeur@gmail.com','ddd','employe'),
(41,1,NULL,2,'DD','Ddd','2024-04-12','','admin888@gmail.com','0778887541','etudiant'),
(42,1,NULL,2,'DGGFGF','Ghghgh','2024-04-12','','admin0000@gmail.cm','7888754156','etudiant'),
(43,1,NULL,2,'ADMIN858','Admin858','1986-04-01','','admin858@gmail.com','','etudiant'),
(45,1,1,2,'dfd','dr','2024-04-10','dfdd','fdf','ff','etudiant'),
(46,1,1,2,'ff','ff','2024-04-12','fff','ffff@gmail.com','fff','etudiant'),
(47,1,1,2,'ff','ff','2024-04-12','fff','fff2555f','fff','etudiant'),
(48,1,1,2,'ddf','ddf','2024-04-12','dff','len@gmail.com','ff','etudiant'),
(49,1,NULL,2,'fff','fff','2024-04-19','fff','d','ffff','etudiant'),
(50,1,NULL,2,'fff','fff','2024-04-19','fff','lenccd@gmail.com','ffff','etudiant'),
(51,1,NULL,2,'Moussa','Meca','2024-04-21','Don','moussa@gmail.com','uyeiuye','etudiant'),
(52,1,NULL,2,'Moussa','Meca','2024-04-21','Don','moussau@gmail.com','uyeiuye','etudiant'),
(53,1,NULL,2,'Moussa','Meca','2024-04-21','Don','moussaum@gmail.com','uyeiuye','etudiant'),
(54,1,NULL,2,'Moussa','Meca','2024-04-21','Don','moussau1m@gmail.com','uyeiuye','etudiant'),
(55,1,NULL,2,'Moussa','Meca','2024-04-21','Don','moussau22nn1m@gmail.com','uyeiuye','etudiant'),
(56,1,NULL,2,'Fatou','Kone','2024-04-21','HH','fatime@gmail.com','ddd','etudiant'),
(57,1,NULL,2,'SALI',' Coulibaly','2024-04-26','gbon','salie@gmail.com','07788845','etudiant'),
(58,1,1,3,'leonnel','ddd','2024-04-11','gbon','7878@gmail.com','ddd','employe'),
(59,1,NULL,2,'yyy','uyuyè','2024-04-23','ggg','reve@gmail.com','rrtr','etudiant'),
(60,1,NULL,2,'KONATE',' N\'golo Hamed','2024-04-25','Gbon','egnon@gmail.com','ruyiouyr','etudiant'),
(61,1,NULL,2,'KONATEVVV',' Nfff Ffff','2024-04-25','fffff','yenn@gmail.com','fff','etudiant'),
(63,1,NULL,2,'KONTEVV',' Konee Lazare','2024-04-25','llll','lazare@gmail.com','uiui','etudiant'),
(64,1,NULL,2,'ALPHA',' Blondy Seydou','2024-04-25','tt','tyyyy@gmail.com','rrr','etudiant'),
(65,1,NULL,2,'IYOIA',' Dfddd','2024-05-07','ddd','ddgg@gmail.com','ddd','etudiant'),
(66,1,NULL,2,'COMPTABLE',' Ufr Seg','2024-05-07','ddd','mdcsmadkk85888min@gmail.com','ddd','etudiant'),
(67,1,NULL,2,'DAVIDO',' Davido','2024-05-07','ddd','davido@gmail.com','ddd','etudiant'),
(68,1,NULL,2,'DAVIDO',' Davido','2024-05-07','ddd','ssdavido@gmail.com','ddd','etudiant'),
(69,1,NULL,2,'COMPTABLE',' Ufr Seg','2024-05-07','ddd','dt@mon-siteweb.com','ddd','etudiant'),
(70,1,NULL,2,'COMPTABLE',' Ufr Seg','2024-05-07','ddd','dst@mon-siteweb.com','ddd','etudiant'),
(71,1,NULL,2,'COMPTABLE',' Ufr Seg','2024-05-07','ddd','ad555555min@mon-siteweb.com','ddd','etudiant'),
(72,1,NULL,2,'IYOIA',' Dfddd','2024-05-07','ddd','cc444ddgg@gmail.com','ddd','etudiant'),
(73,1,NULL,2,'IYOIA',' Dfddd','2024-05-07','ddd','ccuu444ddgg@gmail.com','ddd','etudiant'),
(74,1,NULL,2,'RIA',' Na','2024-05-08','ddd','riaa@gmail.com','ddd','etudiant'),
(75,1,NULL,2,'YELI',' Soro','2024-06-05','jjj','yelies@gmail.com','58855888','etudiant');
