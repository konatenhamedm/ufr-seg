...
class TestController extends AbstractController
{
    ...
    public function exportExcel(): Response
    {
        ...
        $sheet->setCellValue('N1', 'Parcours (accordé)');
        $sheet->setCellValue('O1', 'Niveau d\'étude accordé (2023-2024)');
        $sheet->setCellValue('P1', 'Serie BAC');
        $sheet->setCellValue('Q1', 'Année d\'obtention');
        ...
        $data = [
            [
                'Identifiant Permanent (IP)' => 1, 'Matricule BAC' => 'John Doe', 
                'Nom' => 'Doe', 'Prenoms' => 'John',
                'Date de Naissance' => '01/01/2000', 'Lieu de naissance' => 'Paris',
                'Adresse' => '123 Main Street', 'Sexe' => 'Masculin',
                'Nationalité' => 'Française', 'Etablissement antérieure' => 'Université de Paris',
                'Diplome equivalence (Diplome Presente)' => 'Licence', 'Annee d\'obtention du Diplome' => '2020',
                'Mention (accordée)' => 'Bien', 'Parcours (accordé)' => 'Informatique',
                'Niveau d\'etude accordé (2023-2024)' => 'L3', 'Serie BAC' => 'BAC',
                'Annee d\'obtention' => '2020',
            ],
            [
                'Identifiant Permanent (IP)' => 2, 'Matricule BAC' => 'Jane Doe', 
                'Nom' => 'Doe', 'Prenoms' => 'Jane',
                'Date de Naissance' => '01/01/2000', 'Lieu de naissance' => 'Paris',
                'Adresse' => '123 Main Street', 'Sexe' => 'Feminin',
                'Nationalité' => 'Française', 'Etablissement antérieure' => 'Université de Paris',
                'Diplome equivalence (Diplome Presente)' => 'Licence', 'Annee d\'obtention du Diplome' => '2020',
                'Mention (accordée)' => 'Bien', 'Parcours (accordé)' => 'Informatique',
                'Niveau d\'etude accordé (2023-2024)' => 'L3', 'Serie BAC' => 'BAC',
            ...
            [
                'Identifiant Permanent (IP)' => 3, 'Matricule BAC' => 'Bob Doe', 
                'Nom' => 'Doe', 'Prenoms' => 'Bob',
                'Date de Naissance' => '01/01/2000', 'Lieu de naissance' => 'Paris',
                'Adresse' => '123 Main Street', 'Sexe' => 'Masculin',
                'Nationalité' => 'Française', 'Etablissement antérieure' => 'Université de Paris',
        ...
        foreach ($data as $item) {
            $sheet->setCellValue('A' . $row, $item['Identifiant Permanent (IP)']);
            $sheet->setCellValue('B' . $row, $item['Matricule BAC']);
            $sheet->setCellValue('C' . $row, $item['Nom']);
            $sheet->setCellValue('D' . $row, $item['Prenoms']);
            $sheet->setCellValue('E' . $row, $item['Date de Naissance']);   
            $sheet->setCellValue('F' . $row, $item['Lieu de naissance']);
            $sheet->setCellValue('G' . $row, $item['Adresse']);
            $sheet->setCellValue('H' . $row, $item['Sexe']);
            $sheet->setCellValue('I' . $row, $item['Nationalité']);
            $sheet->setCellValue('J' . $row, $item['Etablissement antérieure']);
            $sheet->setCellValue('K' . $row, $item['Diplome equivalence (Diplome Presente)']);
            $sheet->setCellValue('L' . $row, $item['Annee d\'obtention du Diplome']);
            $sheet->setCellValue('M' . $row, $item['Mention (accordée)']);
            $sheet->setCellValue('N' . $row, $item['Parcours (accordé)']);
            $sheet->setCellValue('O' . $row, $item['Niveau d\'etude accordé (2023-2024)']);
            $sheet->setCellValue('P' . $row, $item['Serie BAC']);
            $sheet->setCellValue('Q' . $row, $item['Annee d\'obtention']);
