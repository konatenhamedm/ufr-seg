    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $table = $dataTableFactory->create()
            ...
            ->add('fichier', TextColumn::class, ['label' => 'Logo', 'render' => function ($value, Filiere $filiere) {
                ...
                return "<img src='https://127.0.0.1:8000/uploads/" . $filiere->getFichier()->getPath()."/" .$filiere->getFichier()->getAlt() . "' width='20px' height='20px' alt=''>" . $filiere->getFichier()->getPath();
