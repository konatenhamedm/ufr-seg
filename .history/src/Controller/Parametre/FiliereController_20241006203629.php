...
class FiliereController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $table = $dataTableFactory->create()
            ...
            ->add('fichier', TextColumn::class, ['label' => '', 'render' => function ($value, Filiere $filiere) {
                ...
                return "<img src='/uploads/" . $filiere->getFichier()->getPath()."/" .$filiere->getFichier()->getAlt() . "' width='40px' height='20px' alt=''>" . $filiere->getFichier()->getPath();
