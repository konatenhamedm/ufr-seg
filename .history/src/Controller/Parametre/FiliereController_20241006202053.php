        ...
        $table = $dataTableFactory->create()
            ...
            ->add('fichier', TextColumn::class, ['label' => 'Logo', 'render' => function ($value, Filiere $filiere) {
                ...
                if ($filiere->getFichier() == null) {
                    return '<img src="https://via.placeholder.com/20x20" width="20px" height="20px" alt="">';
                }
                
                return "<img src='" . $filiere->getFichier()->getPath() . "' width='20px' height='20px' alt=''>" . $filiere->getFichier()->getPath();
                }])
