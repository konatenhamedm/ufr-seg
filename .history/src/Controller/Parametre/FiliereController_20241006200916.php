...
class FiliereController extends AbstractController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $table = $dataTableFactory->create()
            ...
            ->add('fichier', TextColumn::class, ['label' => 'Demandeur', 'render' => function ($value, Preinscription $preinscription) {
                    return "<img src='" . $preinscription->getEtudiant()->getAvatar() . "' width='20px' height='20px' alt=''>" . $preinscription->getEtudiant()->getNomComplet();
                }])
    ...
    #[Route('/config', name: 'app_parametre_filiere_config_index', methods: ['GET', 'POST'])]
    public function indexConfig(Request $request, DataTableFactory $dataTableFactory, SessionInterface $session, AnneeScolaireRepository $anneeScolaireRepository): Response
    {
        ...
        return $this->render('parametre/filiere/config_index.html.twig', [
            'datatable' => $table
        ]);
    }
